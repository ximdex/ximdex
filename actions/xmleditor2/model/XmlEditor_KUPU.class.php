...
class XmlEditor_KUPU extends XmlEditor_Abstract
{
    ...
    public function openEditor($idnode, $view)
    {
        ...
        $jsFiles = array(
            ...
            '/inc/js/i18n.js',
            '/extensions/vendors/hammerjs/hammer.js/hammer.js',
            '/extensions/angular/angular.min.js',
            '/extensions/vendors/RyanMullins/angular-hammer/angular.hammer.js',
            '/extensions/angular-bootstrap/dist/ui-bootstrap-custom-tpls-0.13.0-SNAPSHOT.min.js',
            '/extensions/react/react-with-addons.min.js',
            '/extensions/react/ngReact.min.js',
            ...
            '/inc/js/angular/services/xTranslate.js',
            '/inc/js/angular/services/xMenu.js',
            '/inc/js/angular/services/angularLoad.js',
            '/inc/js/angular/services/xTabs.js',
            '/inc/js/angular/directives/ximButton.js',
            '/inc/js/angular/directives/ximSelect.js',
            '/inc/js/angular/directives/ximMenu.js',
            '/inc/js/angular/directives/ximBrowser.js',
            '/inc/js/angular/directives/ximValidators.js',
            '/inc/js/angular/filters/xFilters.js',
            '/inc/js/angular/directives/ximButton.js',
            '/inc/js/angular/directives/xtagsSuggested.js',
            '/inc/js/angular/directives/ximTree.js',
            '/inc/js/angular/directives/treeNode.jsx.js',
            '/inc/js/angular/controllers/XTagsCtrl.js',
            '/inc/js/angular/controllers/SearchTreeModal.js',
...
//future		$actionURL . '/views/common/css/colorpicker.css',
    ...
    public function getNoRenderizableElements($idNode)
    {
        ...
        if (is_null($docxapId)) {
            Logger::error(_('docxap cannot be found.'));
        }
