		...
		$data['mailchannel'] = $canalCorreo;
	   	...
	   	if(count($data) > 0) {
			...
			if($currentFilter != $data['filter'] || $currentNewsPerBulletin != $data['newsperbull'] || $currentSorting != $data['sortnews'] || $currentName != $data['colector']){
			    ...
			    $oldValues = "Nombre del colector: $currentName;Tipo de colector: $currentType;N�mero de noticias por bolet�n: $currentNewsPerBulletin;Ordenaci�n de noticias: $currentSorting";
