...
//						return ; // The element will not be assigned, thus it will be deleted later
    ...
    function _resolveTemplate($template, $parentElement)
    {
        ...
        Logger::warning('No pvd could be successfully estimated for the node ' . $parentElement['ID']);
        return NULL;
    }
    ...
    function _lookForUUID($uuid)
    {
        ...
        Logger::error('An inconsistency was found in database, there are several UUID in NodeProperties table with same value');
        return NULL;
    }
