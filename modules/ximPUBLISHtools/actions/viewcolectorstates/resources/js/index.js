	...
	(function($) {
	        $.widget('ui.canvas_i', {
				...
				get_colectors_data: function() {
					...
					url = this.options.qm.url + '/?actionid='
				...
				refresh_colectors_data: function(colectors_data) {
					...
					for(var i = 0; i < num_colectors; i++) {
						...
						$('#start_generation_title_' + colectors_data[i].id_colector).text(colectors_data[i].start_generation ? 'Comienzo de la generaci�n:' : '');
						//$('#end_generation_title_' + colectors_data[i].id_colector).text(colectors_data[i].end_generation ? 'Comienzo de la publicaci�n:' : '');
						$('#end_publication_title_' + colectors_data[i].id_colector).text(colectors_data[i].end_publication ? 'Fin de la generaci�n:' : '');
					}
				},
