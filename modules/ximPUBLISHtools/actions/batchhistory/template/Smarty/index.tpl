        ...
        <div class="row tarjeta">
            ...
            <div class="small-12 columns">
                <form>
                    ...
                    <div class="input">
                        <label class="label_title label_general">{t}To{/t} </label>
                        <input type="text" ng-model="searchObj.dateTo">
                    </div>
                    <div class="input">
                        <label class="label_title label_general"> {t}Text to search{/t} </label>
                        <input type="text" ng-model="searchObj.searchText">
                    </div>
                    <div class="small-12 columns">
